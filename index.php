...
<head>
	...
	<script>
		...
		function remover(id) {
			location.href = 'index.php?pag=index&acao=remover&id=' + id;//redirecionando para página com todas as tarefas + concatenando com o id passado por parâmetro
		}

		function marcarRealizada(id) {
			location.href = 'index.php?acao=marcarRealizada&id=' + id;//redirecionando para página com todas as tarefas + concatenando com o id passado por parâmetro
		}
	</script>
</head>
